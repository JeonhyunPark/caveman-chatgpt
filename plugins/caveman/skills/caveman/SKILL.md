...
description: >
  ...
  /caveman, "caveman", "caveman lite", "caveman full", "caveman ultra",
  "caveman mode", "talk like caveman", "be brief" or "less tokens".
---
...
Default: **full**. Switch: `caveman` or `/caveman lite|full|ultra|off`. Slash optional. `stop caveman`, `caveman off`, and `normal mode` turn it off.
